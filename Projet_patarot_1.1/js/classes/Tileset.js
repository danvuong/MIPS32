function Tileset(url) {
	...
	this.image.onload = function(){
		...
		this.referenceDuTileset.largeur = this.width / (taille_fenetre()[0]/15);
	}
...
Tileset.prototype.dessinerTile = function(numero, context, xDestination, yDestination) {
	...
	context.drawImage(this.image, xSource, ySource, 32, 32, xDestination, yDestination, (taille_fenetre()[0]/15), (taille_fenetre()[0]/15));
}
