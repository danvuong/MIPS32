...
function personnage(url,x,y,direction){
  ...
  personnage.prototype.dessinerpersonnage = function(contexte){
    ...
    var pixelsAParcourir = (taille_fenetre()[0]/15) - ((taille_fenetre()[0]/15) * (this.etatAnimation / DUREE_DEPLACEMENT));
	...
	if(this.etat == 1)
		{
		contexte.drawImage(this.sprite,0,0,this.largeur,this.hauteur,this.x*(taille_fenetre()[0]/15)+decalageX,this.y*(taille_fenetre()[0]/15)+decalageY,(taille_fenetre()[0]/15),(taille_fenetre()[0]/15))
		};
  }
